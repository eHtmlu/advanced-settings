...
advset_register_feature([
    ...
    'execution_handler' => function() {
        ...
        // Since WP 7 the admin emoji hooks are registered in wp-admin/includes/admin-filters.php,
        // which loads after plugins_loaded/init, so they can be removed no earlier than admin_init.
