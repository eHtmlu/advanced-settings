...
<div class="wrap">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 3rem; justify-content: center; ">
        <div style="max-width: 15.625rem; flex-grow: 0; padding-top: 4rem; ">
            <img src="https://secure.gravatar.com/avatar/6cac4917ddfefe7d5d24a2491c13231643c7e5a4d2278aeb6f1f8d5cccf6750c?s=500" width="250" height="250" style="background: rgba(0, 0, 0, .5); width: 100%; height: auto; box-sizing: border-box; rotate: -2.5deg; box-shadow: .25rem .5rem 1rem #0003; border: currentColor solid 0px; border-radius: 1rem; " />
        </div>
